...
public class SeaStacksFeature extends Feature<NoneFeatureConfiguration> {
    ...
    private void placeStackLayerAt(WorldGenLevel level, BlockPos origin, BlockPos.MutableBlockPos cursor, BlockState state, int radius, int height, RandomSource random, int y,
