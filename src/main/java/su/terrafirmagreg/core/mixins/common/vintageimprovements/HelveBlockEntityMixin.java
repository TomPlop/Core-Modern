...
public class HelveBlockEntityMixin {
    ...
    /**
     * @author Ujhik
     * @reason Fix helve hammer not processing output items like for example helve hammer processing iron bloom into
	 * refined iron bloom but not this last into iron ingot without removing the refined ones and adding them again.
     */
    /*@WrapOperation(
            method = "tick",
            at = @At(
