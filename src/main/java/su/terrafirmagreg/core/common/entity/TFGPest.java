package su.terrafirmagreg.core.common.entity;
...
// Like TFC's Pest class, but with less restrictions and no despawning

public class TFGPest extends Prey {

    public static final EntityDataAccessor<Boolean> DATA_CLIMBING = SynchedEntityData.defineId(TFGPest.class, EntityDataSerializers.BOOLEAN);
    ...
    public TFGPest(EntityType<? extends Prey> type, Level level, TFCSounds.EntitySound sounds) {
