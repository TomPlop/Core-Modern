...
package su.terrafirmagreg.core.common.entity.ai.amphibian;
...
public class PinnipedAI {
    ...
    public static final ImmutableList<SensorType<? extends Sensor<? super AmphibiousAnimal>>> SENSOR_TYPES = ImmutableList.of(SensorType.NEAREST_LIVING_ENTITIES, SensorType.NEAREST_ADULT,
            SensorType.HURT_BY, TFCBrain.TEMPTATION_SENSOR.get());
    public static final ImmutableList<? extends MemoryModuleType<?>> MEMORY_TYPES = ImmutableList.of(
            ...
            MemoryModuleType.WALK_TARGET, MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, MemoryModuleType.PATH, MemoryModuleType.ATTACK_TARGET, MemoryModuleType.ATTACK_COOLING_DOWN,
            MemoryModuleType.HUNTED_RECENTLY,
            MemoryModuleType.HURT_BY_ENTITY, MemoryModuleType.HOME, MemoryModuleType.TEMPTING_PLAYER, MemoryModuleType.IS_TEMPTED, MemoryModuleType.TEMPTATION_COOLDOWN_TICKS,
    ...
    public static void initRetreatActivity(Brain<? extends AmphibiousAnimal> brain) {
        brain.addActivityAndRemoveMemoryWhenStopped(Activity.AVOID, 10, ImmutableList.of(
                ...
                createIdleMovementBehaviors()), MemoryModuleType.HURT_BY_ENTITY);
    }
    ...
    private static void initFightActivity(Brain<? extends AmphibiousAnimal> brain) {
        brain.addActivityAndRemoveMemoryWhenStopped(Activity.FIGHT, 0, ImmutableList.of(
                ...
                EraseMemoryIf.create(PinnipedAI::isTempted, MemoryModuleType.ATTACK_TARGET)), MemoryModuleType.ATTACK_TARGET);
    }
    ...
    private static boolean canSetWalkTargetFromLookTarget(LivingEntity entity) {
        ...
        if (tracker.isPresent()) {
            ...
            return EnvironmentHelpers.isWater(blockstate) == entity.isInWaterOrBubble();
        }
        return false;
    }
