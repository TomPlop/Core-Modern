...
public class TFGEntities {
	...
	public static final RegistryObject<EntityType<TFCGlacianRam>> GLACIAN_RAM = register("glacian_ram",EntityType.Builder.of(TFCGlacianRam::makeTFCGlacianRam, MobCategory.CREATURE).sized(1f, .9f).clientTrackingRange(10));
	...
	public static final RegistryObject<EntityType<TFCWraptor>> WRAPTOR = register("wraptor", EntityType.Builder.of(TFCWraptor::makeTFCWraptor, MobCategory.CREATURE).sized(0.8F, 2.2F).clientTrackingRange(10));
