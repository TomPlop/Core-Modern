...
public class TFCWraptorModel<E extends TFCWraptor> extends HierarchicalModel<E> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        leftKnee.addOrReplaceChild("leftFoot", CubeListBuilder.create().texOffs(-9, 0).addBox(-2.5F, 0.0F, -6.0F, 5.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 0.0F));
        ...
        rightKnee.addOrReplaceChild("rightFoot", CubeListBuilder.create().texOffs(-9, 0).mirror().addBox(-2.5F, 0.0F, -6.0F, 5.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 6.0F, 0.0F));
        ...
        body.addOrReplaceChild("bodyFeathers", CubeListBuilder.create().texOffs(0, 19).addBox(-4.0F, -5.5F, -5.5F, 8.0F, 11.0F, 11.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -1.5F, -2.0F));
        PartDefinition rightWing = body.addOrReplaceChild("rightWing", CubeListBuilder.create(), PartPose.offset(-4.0F, -7.0F, -6.5F));
        rightWing.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(-17, 63).mirror().addBox(-30.0F, 0.0F, -5.0F, 30.0F, 0.0F, 17.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.7854F, -1.0472F));
        PartDefinition leftWing = body.addOrReplaceChild("leftWing", CubeListBuilder.create(), PartPose.offset(4.0F, -7.0F, -6.5F));
        leftWing.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(-17, 63).addBox(0.0F, 0.0F, -5.0F, 30.0F, 0.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.7854F, 1.0472F));
        ...
        tailFeathers.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(41, 0).addBox(-5.0F, 0.0F, 0.0F, 10.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
        ...
        neck.addOrReplaceChild("neckFeathersTop", CubeListBuilder.create().texOffs(56, 28).addBox(-2.5F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.0F, 0.0F));
        neck.addOrReplaceChild("neckFeathersMid", CubeListBuilder.create().texOffs(60, 57).addBox(-2.5F, -2.0F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.5F, 0.0F));
        PartDefinition head = neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(48, 11).addBox(-3.0F, -5.0F, -2.5F, 6.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(32, 16).addBox(-2.5F, -2.0F, -8.5F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 21).addBox(-2.5F, 0.0F, -8.5F, 5.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -13.0F, 0.0F));
        head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(55, 49).addBox(-2.5F, -1.0F, -7.0F, 5.0F, 1.0F, 7.0F, new CubeDeformation(-0.01F)), PartPose.offset(0.0F, 0.0F, -1.25F));
        head.addOrReplaceChild("headFeathers", CubeListBuilder.create().texOffs(0, 41).addBox(-3.5F, -3.0F, -2.5F, 7.0F, 6.0F, 5.0F, new CubeDeformation(0.25F)), PartPose.offset(0.0F, -2.0F, 0.0F));
        ...
        hairTuft.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 50).addBox(0.0F, 0.5F, -3.5F, 0.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.5F, 0.0F, 0.0F, 1.5708F, 0.0F));
        PartDefinition topFrill = head.addOrReplaceChild("topFrill", CubeListBuilder.create(), PartPose.offset(0.0F, -5.0F, 0.0F));
        topFrill.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(49, 37).addBox(-4.0F, -5.5F, 0.0F, 8.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 1.5708F, 0.0F, -1.5708F));
        head.addOrReplaceChild("leftFrill", CubeListBuilder.create().texOffs(49, 37).addBox(0.0F, -5.5F, 0.0F, 8.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -2.5F, 0.5F));
        head.addOrReplaceChild("rightFrill", CubeListBuilder.create().texOffs(49, 37).mirror().addBox(-8.0F, -5.5F, 0.0F, 8.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, -2.5F, 0.5F));
        neck.addOrReplaceChild("neckFeathersBottom", CubeListBuilder.create().texOffs(60, 66).addBox(-6.0F, -15.0F, -4.0F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(3.5F, 12.0F, 1.5F));
