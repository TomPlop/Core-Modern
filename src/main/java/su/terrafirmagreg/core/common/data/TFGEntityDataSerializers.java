...
public final class TFGEntityDataSerializers {
    ...
    public static final RegistryObject<EntityDataSerializer<TFCSniffer.State>> SNIFFER_STATE = register("sniffer_state", () -> EntityDataSerializer.simpleEnum(TFCSniffer.State.class));
